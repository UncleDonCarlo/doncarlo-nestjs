...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.id, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], UserDetail.prototype, "phoneNo", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Date)
], UserDetail.prototype, "deletedAt", void 0);
exports.UserDetail = UserDetail = __decorate([
    (0, typeorm_1.Entity)('usersDetails')
], UserDetail);
