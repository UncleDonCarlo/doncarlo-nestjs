...
let InformationRepository = class InformationRepository extends typeorm_1.Repository {
    constructor(dataSource) {
        super(information_entity_1.Information, dataSource.createEntityManager());
